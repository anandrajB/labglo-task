...
class UniversityModelTest(TestCase):
    ...
    def test_university_ordering(self):
        University.objects.create(
            name="B University", address="Address B", established_on=1985
        )
        University.objects.create(
            name="A University", address="Address A", established_on=1980
        )
...
class StudentModelTest(TestCase):
    def setUp(self):
        self.university = University.objects.create(
            name="Model Test University", address="123 Test Street", established_on=1990
        )
...
class StudentUniversityAPITest(TestCase):
    def setUp(self):
        ...
        self.university = University.objects.create(
            name="Test University", address="123 Test Street", established_on=1990
        )
